...
and IMU-based orientation display. Connects to SangamIO for raw sensor data.
"""
...
class MainWindow(QMainWindow):
    """Main application window for sensor mode with robot diagram."""
    ...
    def __init__(self, robot_ip="192.168.68.101", port=5555, log_raw_packets=False):
        ...
        # Initialize UI
        self.setWindowTitle(f"Drishti Sensor - CRL-200S ({robot_ip})")
        ...
        # Content area: robot view (left) + control panel (right)
    ...
    def _create_title_bar(self):
        ...
        title_label = QLabel("Drishti Sensor - CRL-200S")
    ...
    def _start_telemetry(self):
        ...
        try:
            self.status_bar.showMessage("Connecting to SangamIO...")
